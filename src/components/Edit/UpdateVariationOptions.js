    ...
    return (
        <Fragment> 
            ...
            <ul className="variation-list">
                {props.variationOptions.map((option, index) => <li  key={option || 0 } ><FormControl value={ props.variationOptionValue[option]} onChange={ e => props.handleAddVariationOptionValue(e, index) }/>
